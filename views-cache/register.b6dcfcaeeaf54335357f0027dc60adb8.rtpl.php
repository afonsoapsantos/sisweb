<?php if(!class_exists('Rain\Tpl')){exit;}?><form class="ui form">
  ...
  <div class="field">
    ...
    <div class="fields">
      ...
      <div class="four wide field">
        <input type="text" name="shipping[address-2]" placeholder="Apto">
      </div>
    </div>
  </div>
  <div class="two fields">
    ...
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        ...
        <div class="default text">Selecione o País</div>
        <div class="menu">
  ...
  <div class="field">
    ...
    <div class="ui selection dropdown">
      ...
      <div class="menu">
        ...
        <div class="item" data-value="discover"><i class="discover icon"></i> Descobrir </div>
      </div>
    </div>
  </div>
  <div class="fields">
    <div class="seven wide field">
      ...
      <input type="text" name="card[number]" maxlength="16" placeholder="Número do Cartão">
    </div>
   ...
   <div class="field">
    <label>Enviar recibo para:</label>
    <div class="ui fluid multiple search selection dropdown">
      <input type="hidden" name="receipt">
      <i class="dropdown icon"></i>
      <div class="default text">Contatos Salvos</div>
      <div class="menu">
        <div class="item" data-value="jenny" data-text="Jenny">
        	<img class="ui mini avatar image" src=""> Jenny Hess
        </div>
        <div class="item" data-value="elliot" data-text="Elliot">
        	<img class="ui mini avatar image" src=""> Elliot Fu 
        </div>
        <div class="item" data-value="stevie" data-text="Stevie">
        	<img class="ui mini avatar image" src=""> Stevie Feliciano 
        </div>
        <div class="item" data-value="christian" data-text="Christian">
        	<img class="ui mini avatar image" src=""> Christian 
        </div>
        <div class="item" data-value="matt" data-text="Matt">
        	<img class="ui mini avatar image" src=""> Matt 
        </div>
        <div class="item" data-value="justen" data-text="Justen">
        	<img class="ui mini avatar image" src=""> Justen Kitsune
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="ui button" tabindex="0">Enviar pedido</div>
</form>