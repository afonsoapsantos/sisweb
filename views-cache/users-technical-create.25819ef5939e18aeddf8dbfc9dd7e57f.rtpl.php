      ...
      <div class=" twelve wide column" align="center">
        <div class="field">
          ...
          <div class="ui buttons">
            <a class="ui green button" href="/manager/users/technical/create">
              <i class="plus icon"></i> Adicionar Técnico
            </a>
            <a class="ui green button" href="/manager/users/technical">
        ...
        <div class="field">
          ...
          <form class="ui form" action="/manager/users/technical/create" method="POST">
            ...
            <div class="field">
              ...
              <a class="ui red button" href="/manager/users/technical">
