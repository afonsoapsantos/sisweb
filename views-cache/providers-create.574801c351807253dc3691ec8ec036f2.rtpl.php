...
<div class="ui segment">
	...
	<div class="field">
		<form class="ui form" method="POST" action="/admin/providers/create">
			...
			<div class="ui field" style="margin-left: 60px; margin-right: 60px;">
				...
				<div class="ui field" align="left">
					...
					<div class="field">
						<label class="ui black label">Razão Social: </label>
						<input type="text" name="txcorporatename">
					</div>

					<div class="field">
						<label class="ui black label">Nome Fantasia: </label>
						<input type="text" name="txfantasyname">
					</div>

					<div class="field">
						<label class="ui black label">CNPJ: </label>
						<input type="number" name="nucnpj">
					</div>

					<div class="field">
						<label class="ui black label">Inscrição Estadual: </label>
						<input type="number" name="nustateregistration">
					</div>

					<div class="field">
						<label class="ui black label">Inscrição Municipal: </label>
				...
				<div class="ui buttons">
					...
					<a href="/admin/providers/create" class="ui red button">Cancelar</a>
				</div>
			</div>
