      ...
      <div class=" twelve wide column" align="center">
        <div class="field">
          ...
          <div class="ui buttons">
            <a class="ui green button" href="/manager/users/farmworker/create">
              <i class="plus icon"></i>Adicionar Funcionário Fazenda
            </a>
            <a class="ui green button" href="/manager/users/farmworker">
              <i class="list icon"></i>Funcionários Fazenda
            </a>
          </div>
        </div>
        <div class="field">
          <div class="ui horizontal divider">Funcionários da Fazenda</div>
