...
<div class="ui segment">
	...
	<div class="field" id="margins">
		...
		<table class="ui very basic table">
			...
			<tbody>
				<?php $counter1=-1;  if( isset($mediasOrders) && ( is_array($mediasOrders) || $mediasOrders instanceof Traversable ) && sizeof($mediasOrders) ) foreach( $mediasOrders as $key1 => $value1 ){ $counter1++; ?>
				<tr>
					...
					<td>
						<a class="circular ui icon red button" href="/technical/media/download/<?php echo htmlspecialchars( $value1["idmedia"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
