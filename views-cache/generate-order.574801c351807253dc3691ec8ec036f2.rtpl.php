...
<div class="ui segment">
	...
	<div class="ui buttons">
		<a class="ui green button" href="/admin/requests"><i class="list icon"></i>Solicitações</a>
		<a class="ui green button" href=""><i class="list icon"></i>Ordens</a>
		<a class="ui green button" href=""><i class="list icon"></i>Clientes</a>
	</div>
	<br><br>
	<div>
		...
		<form class="ui form" method="POST" action="/admin/orders/create">
			<div class="ui field" id="margins">
				...
				<div align="left" class="field">
					...
					<input type="text" readonly="true" value="<?php echo htmlspecialchars( $request["txnamefarm"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
				</div>	
			...
			<div class="ui buttons">
				...
				<a class="ui red button" href="/admin/requests"><i class="delete icon"></i>Cancelar</a>
			</div><br>	
		</form><br>
